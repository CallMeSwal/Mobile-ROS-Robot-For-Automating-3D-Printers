            ...
            if detection.id==(1,):
                ...
                if pos_z > DISTANCE_TO_TAG+0.4:
                    if pos_x > 0.01:
                        ...
                        speed_y=0.00
                        print("forwards fast")
                elif pos_z > DISTANCE_TO_TAG+0.1:
                    if pos_x > 0.005:
                        speed_x=0.01
                        speed_y=0.01
                    ...
                    if pos_x > 0.0025:
                        speed_x=0.002
                        speed_y=0.002
                        print("forwards left slow")
                    elif pos_x < -0.0025:
                        speed_x=0.002
                        speed_y=-0.002
                        print("forwards right slow")
                    else:
                        speed_x=0.002
                        speed_y=0.00
                        print("forwards")
                    ...
                    end_counter+=1
                    if end_counter>100:
                        os.system("rosnode kill ZZZ_p2_locate_prusa")
                        print("End Program")
    else:
...
def controller():
    ...
    # run simultaneously.
    rospy.init_node('ZZZ_p2_locate_prusa')
    rate=rospy.Rate(10)
