...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/mangokid/wombat/install_isolated/lib/python2.7/dist-packages:/home/mangokid/wombat/src/wheel/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/mangokid/wombat/src/wheel" \
    "/usr/bin/python" \
    "/home/mangokid/wombat/src/wheel/setup.py" \
     \
    build --build-base "/home/mangokid/wombat/src/wheel" \
    install \
    --root="${DESTDIR-/}" \
